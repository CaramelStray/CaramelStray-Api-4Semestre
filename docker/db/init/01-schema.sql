...
CREATE TABLE tb_cad_perfil (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    descricao VARCHAR(100) NOT NULL
);

CREATE TABLE tb_cad_permissao (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    descricao VARCHAR(100) NOT NULL
);
...
CREATE TABLE tb_cad_cliente (
    ...
    descricao_responsavel VARCHAR(255),
    pais VARCHAR(100),
    estado_regiao VARCHAR(100),
    cidade VARCHAR(100),
    classificacao_distancia VARCHAR(100),
...
CREATE TABLE tb_cad_funcionario (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    codigo_usuario INTEGER UNIQUE,
...
CREATE TABLE tb_cad_catalogo_maquina (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE tb_cad_catalogo_software (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    descricao VARCHAR(255) NOT NULL
);

CREATE TABLE tb_cad_catalogo_tarefa (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    descricao VARCHAR(255) NOT NULL,
    categoria VARCHAR(100)
);

CREATE TABLE tb_cad_catalogo_ativo (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE tb_cad_tipo_manutencao (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    descricao VARCHAR(100) NOT NULL UNIQUE,
    observacao VARCHAR(255)
);

CREATE TABLE tb_cad_habilidade (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    descricao VARCHAR(100) NOT NULL UNIQUE,
    observacao VARCHAR(255)
);

CREATE TABLE tb_cad_usuario_perfil (
    ...
    CONSTRAINT fk_usuario_perfil_perfil
        FOREIGN KEY (codigo_perfil) REFERENCES tb_cad_perfil(codigo)
        ON DELETE CASCADE
);

CREATE TABLE tb_cad_perfil_permissao (
    codigo_perfil INTEGER NOT NULL,
    codigo_permissao INTEGER NOT NULL,
    CONSTRAINT pk_perfil_permissao PRIMARY KEY (codigo_perfil, codigo_permissao),
    CONSTRAINT fk_perfil_permissao_perfil
        FOREIGN KEY (codigo_perfil) REFERENCES tb_cad_perfil(codigo)
        ON DELETE CASCADE,
    CONSTRAINT fk_perfil_permissao_permissao
        FOREIGN KEY (codigo_permissao) REFERENCES tb_cad_permissao(codigo)
        ON DELETE CASCADE
);

CREATE TABLE tb_cad_ativo_estoque (
...
CREATE TABLE tb_srv_maquina_contrato (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE tb_srv_maquina_software_instalado (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE tb_cad_catalogo_maquina_checklist_padrao (
    codigo_catalogo_maquina INTEGER NOT NULL,
...
CREATE TABLE tb_cad_catalogo_software_checklist_padrao (
...
CREATE TABLE tb_cad_catalogo_maquina_ferramenta_modelo (
    codigo_catalogo_maquina INTEGER NOT NULL,
    codigo_catalogo_ativo INTEGER NOT NULL,
...
CREATE TABLE tb_cad_funcionario_habilidade (
...
CREATE TABLE tb_cad_tipo_manutencao_habilidade (
...
CREATE TABLE tb_srv_maquina_historico_manutencao (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    codigo_maquina_contrato INTEGER NOT NULL,
...
CREATE TABLE tb_srv_maquina_funcionario_manutencao (
...
CREATE TABLE tb_srv_maquina_checklist_manutencao (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    codigo_historico_manutencao INTEGER NOT NULL,
    codigo_tarefa INTEGER NOT NULL,
    realizado BOOLEAN,
...
CREATE TABLE tb_srv_maquina_checklist_ferramenta_manutencao (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    codigo_historico_manutencao INTEGER NOT NULL,
    codigo_catalogo_ativo INTEGER NOT NULL,
...
CREATE TABLE tb_srv_maquina_observacao_manutencao (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    codigo_historico_manutencao INTEGER NOT NULL,
    codigo_funcionario INTEGER NOT NULL,
    observacao TEXT,
...
CREATE TABLE tb_srv_maquina_troca_imprevista_manutencao (
    codigo INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    codigo_historico_manutencao INTEGER NOT NULL,
    codigo_funcionario INTEGER NOT NULL,
